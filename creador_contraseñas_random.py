...
def generador_contraseña(cantidadNum, cantidadCarac, cantidadEspecial):
    ...
    for i in range(1, cantidadNum): # una ciclo que se repita las veces que se desea escoger la cantidad de numeros que solicita el usuario
...
print("Bienvenido al generador de contraseñas randoms")
